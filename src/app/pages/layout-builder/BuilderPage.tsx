...
import {getLayout, ILayout, LayoutSetup, useLayout} from '../../../_cloner/layout/core'
        ...
        <div className='card-body d-flex align-items-center py-8'>
          ...
          {/* end::Icon */}
           ...
           <div className='ms-6'>
            ...
            <p className='list-unstyled text-gray-600 fw-semibold fs-6 p-0 m-0'>
              Also, you can configurate the Layout in the code (<code>src/_cloner/layout/core/DefaultLayoutConfig.ts</code> file). Don't forget clear your local storage when you are changing DefaultLayoutConfig.
            </p>
          </div>
          {/* end::Description */}
        </div>
